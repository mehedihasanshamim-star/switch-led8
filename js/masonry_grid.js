;(
	function ($) {
		'use strict';
		$.fn.cre_dlAddonsGridLayout = function () {
			...
			return this.each(function () {
                ...
                $('.cre-filter-buttons li a').on('click', function () {
                    $('.cre-filter-buttons').find('.current').removeClass('current');
